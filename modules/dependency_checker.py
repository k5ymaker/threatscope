...
INSTALL_COMMANDS: dict[str, dict[str, str]] = {
    ...
    "nikto": {
        "kali":    "sudo apt install -y nikto",
        "debian":  "sudo apt install -y nikto",
        "ubuntu":  "sudo apt install -y nikto",
        "arch":    "sudo pacman -S --noconfirm nikto",
        "fedora":  "sudo dnf install -y nikto",
        "rhel":    "sudo yum install -y nikto",
        "macos":   "brew install nikto",
        "windows": "Manual: https://github.com/sullo/nikto",
        "unknown": "Manual: https://github.com/sullo/nikto",
    },
    "gobuster": {
        "kali":    "sudo apt install -y gobuster",
        "debian":  "sudo apt install -y gobuster",
        "ubuntu":  "sudo apt install -y gobuster",
        "arch":    "go install github.com/OJ/gobuster/v3@latest",
        "fedora":  "go install github.com/OJ/gobuster/v3@latest",
        "rhel":    "go install github.com/OJ/gobuster/v3@latest",
        "macos":   "brew install gobuster",
        "windows": "go install github.com/OJ/gobuster/v3@latest",
        "unknown": "go install github.com/OJ/gobuster/v3@latest",
    },
    "ffuf": {
        "kali":    "sudo apt install -y ffuf",
        "debian":  "sudo apt install -y ffuf",
        "ubuntu":  "sudo apt install -y ffuf",
        "arch":    "go install github.com/ffuf/ffuf/v2@latest",
        "fedora":  "go install github.com/ffuf/ffuf/v2@latest",
        "rhel":    "go install github.com/ffuf/ffuf/v2@latest",
        "macos":   "brew install ffuf",
        "windows": "go install github.com/ffuf/ffuf/v2@latest",
        "unknown": "go install github.com/ffuf/ffuf/v2@latest",
    },
    "wfuzz": {
        **{os_name: "pip install wfuzz" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "dirsearch": {
        **{os_name: "pip install dirsearch" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "sqlmap": {
        "kali":    "sudo apt install -y sqlmap",
        "debian":  "sudo apt install -y sqlmap",
        "ubuntu":  "sudo apt install -y sqlmap",
        "arch":    "sudo pacman -S --noconfirm sqlmap",
        "fedora":  "pip install sqlmap",
        "rhel":    "pip install sqlmap",
        "macos":   "brew install sqlmap",
        "windows": "pip install sqlmap",
        "unknown": "pip install sqlmap",
    },
    "dalfox": {
        **{os_name: "go install github.com/hahwul/dalfox/v2@latest" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "nuclei": {
        **{os_name: "go install -v github.com/projectdiscovery/nuclei/v3/cmd/nuclei@latest" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "wafw00f": {
        **{os_name: "pip install wafw00f" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "whatweb": {
        "kali":    "sudo apt install -y whatweb",
        "debian":  "sudo apt install -y whatweb",
        "ubuntu":  "sudo apt install -y whatweb",
        "arch":    "gem install whatweb",
        "fedora":  "gem install whatweb",
        "rhel":    "gem install whatweb",
        "macos":   "brew install whatweb",
        "windows": "gem install whatweb",
        "unknown": "gem install whatweb",
    },
    "commix": {
        "kali":    "sudo apt install -y commix",
        "debian":  "sudo apt install -y commix",
        "ubuntu":  "sudo apt install -y commix",
        "arch":    "pip install commix",
        "fedora":  "pip install commix",
        "rhel":    "pip install commix",
        "macos":   "pip install commix",
        "windows": "pip install commix",
        "unknown": "pip install commix",
    },
    "testssl": {
        "kali":    "sudo apt install -y testssl.sh",
        "debian":  "sudo apt install -y testssl.sh",
        "ubuntu":  "sudo apt install -y testssl.sh",
        "arch":    "sudo pacman -S --noconfirm testssl.sh",
        "fedora":  "Manual: https://github.com/drwetter/testssl.sh",
        "rhel":    "Manual: https://github.com/drwetter/testssl.sh",
        "macos":   "brew install testssl",
        "windows": "Manual: https://github.com/drwetter/testssl.sh",
        "unknown": "Manual: https://github.com/drwetter/testssl.sh",
    },
    "wpscan": {
        **{os_name: "gem install wpscan" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "droopescan": {
        **{os_name: "pip install droopescan" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "arjun": {
        **{os_name: "pip install arjun" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "paramspider": {
        **{os_name: "pip install paramspider" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "katana": {
        **{os_name: "go install github.com/projectdiscovery/katana/cmd/katana@latest" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "gospider": {
        **{os_name: "go install github.com/jaeles-project/gospider@latest" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "trufflehog": {
        **{os_name: "go install github.com/trufflesecurity/trufflehog/v3@latest" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
    "gitleaks": {
        **{os_name: "go install github.com/gitleaks/gitleaks/v8@latest" for os_name in ["kali","debian","ubuntu","arch","fedora","rhel","macos","windows","unknown"]},
    },
}
...
DEPENDENCY_REGISTRY: list[dict] = [
    ...
    # Web App Pentesting binaries
    {"name": "nikto",             "key": "nikto",             "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Web server vulnerability scanner"},
    {"name": "gobuster",          "key": "gobuster",          "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Directory/DNS/vhost brute-forcer"},
    {"name": "ffuf",              "key": "ffuf",              "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Fast web fuzzer"},
    {"name": "wfuzz",             "key": "wfuzz",             "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Web application fuzzer"},
    {"name": "dirsearch",         "key": "dirsearch",         "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Web path discovery tool"},
    {"name": "sqlmap",            "key": "sqlmap",            "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Automated SQL injection scanner"},
    {"name": "dalfox",            "key": "dalfox",            "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "XSS vulnerability scanner"},
    {"name": "nuclei",            "key": "nuclei",            "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Template-based vulnerability scanner"},
    {"name": "wafw00f",           "key": "wafw00f",           "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "WAF detection and fingerprinting"},
    {"name": "whatweb",           "key": "whatweb",           "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Web technology fingerprinting"},
    {"name": "commix",            "key": "commix",            "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "OS command injection scanner"},
    {"name": "testssl",           "key": "testssl",           "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "TLS/SSL vulnerability tester"},
    {"name": "wpscan",            "key": "wpscan",            "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "WordPress vulnerability scanner"},
    {"name": "droopescan",        "key": "droopescan",        "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Drupal/SilverStripe scanner"},
    {"name": "arjun",             "key": "arjun",             "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "HTTP parameter discovery tool"},
    {"name": "paramspider",       "key": "paramspider",       "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "URL parameter spider"},
    {"name": "katana",            "key": "katana",            "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Fast web crawler with JS support"},
    {"name": "gospider",          "key": "gospider",          "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Web spider for recon"},
    {"name": "trufflehog",        "key": "trufflehog",        "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Secrets and credential scanner"},
    {"name": "gitleaks",          "key": "gitleaks",          "type": "binary",     "required_by": ["Web App Pentest"],   "optional": True,  "check_fn": "check_binary",     "description": "Git repository secret scanner"},
    # API keys
